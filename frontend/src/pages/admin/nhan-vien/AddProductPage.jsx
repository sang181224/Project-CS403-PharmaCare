...
function AddProductPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        gia_ban: '',
        mo_ta: '',
        // Các trường cho lô hàng đầu tiên
        ma_lo_thuoc: '',
        so_luong_nhap: '',
        gia_nhap: '',
        ngay_san_xuat: '',
    ...
    // Cập nhật state khi người dùng chọn file ảnh
    ...
    const handleSubmit = async (e) => {
        ...
        // Thêm tất cả các trường từ state formData vào
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/products`, {
                method: 'POST',
                body: data,
                // Không cần header 'Content-Type' khi dùng FormData
            });
            ...
            <form onSubmit={handleSubmit}>
                <div className="bg-white p-8 rounded-2xl shadow-lg space-y-8">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            <div><label htmlFor="ma_lo_thuoc" className="block text-sm font-medium">Mã lô</label><input type="text" id="ma_lo_thuoc" name="ma_lo_thuoc" value={formData.ma_lo_thuoc} onChange={handleChange} className="w-full mt-1 px-4 py-2 border rounded-lg" required /></div>
